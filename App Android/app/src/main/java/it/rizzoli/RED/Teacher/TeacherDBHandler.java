...
public class TeacherDBHandler extends SQLiteOpenHelper {
    ...
    public TeacherDBHandler(Context context) {
    ...
    public ArrayList<TeacherCourseModal> readCourses() {
        ...
        ArrayList<TeacherCourseModal> teacherCourseModalArrayList = new ArrayList<>();

        // moving our cursor to first position.
        if (cursorCourses.moveToFirst()) {
            do {
                // on below line we are adding the data from cursor to our array list.
                teacherCourseModalArrayList.add(new TeacherCourseModal(cursorCourses.getString(1),
        ...
        cursorCourses.close();
        return teacherCourseModalArrayList;
    }
